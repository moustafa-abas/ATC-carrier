...
const One = (data) => {
  ...
  return (
    <main className='feature flex justify-between gap-10 my-10 shadow-xl shadow-black-200 flex-col-reverse md:h-fit lg:h-80 md:flex-row rounded-lg' key={Data.title}>
