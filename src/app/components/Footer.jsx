...
const Footer = () => {
  return (
    <footer className=" mt-20   flex bg-blue-900 py-5 text-white flex-col-reverse sm:flex-row   sm:flex-wrap-reverse lg:flex-nowrap">
      <div className="lg:w-1/4  w-full capitalize  sm:border-t-2 sm:mt-8 sm:pt-3 border-gray-400 px-4 py-4 sm:py-0 lg:mt-0 lg:pt-0 lg:border-t-0 lg:border-r-2">
      ...
      <div className="sm:w-1/3 lg:w-1/4 w-full capitalize border-b-2 sm:border-b-0 sm:border-r-2 border-gray-400 px-4 flex gap-5 py-4 sm:py-0">
        <div>
      ...
      <div className=" sm:w-1/3 w-full lg:w-1/4 capitalize border-b-2 sm:border-b-0   px-4 flex gap-5 py-4 sm:py-0 ">
        <div>
          <FontAwesomeIcon icon={faLocationDot} className="text-5xl mt-7 " />
        </div>
        <div className=" ">
